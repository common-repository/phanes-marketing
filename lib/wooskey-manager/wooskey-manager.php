    ...
    public function check_license() {
        ...
        if ( empty( $this->request_url ) || empty( $this->license_code ) || $this->error == true ) {
            ...
            $this->response_msg     = empty( $this->request_url || $this->error == true ) ?
                'Invalid URL or License Code set.' : 'Invalid License Code set. e-mail info@phanes.co for support';
        ...
        if ( $response == null ) {
            ...
            $this->response_msg     = $this->curl_error == null ? 'Error Occurred while verifying License Code. e-mail info@phanes.co for support' : $this->curl_error;
        ...
        elseif ( $response == false ) {
            ...
            $this->response_error   = true;
            $this->response_code    = 'WOOSKEY_417';
            $this->response_msg     = 'Error Occurred while verifying License Code. e-mail info@phanes.co for support';
